	        ...
	        switch (_this2.gameStatus) {
	          case "StartScreen":
	            if (!_this2.startScreenShowing) {
	              ...
	              _this2.Title = new createjs.Text("Dotty Dots", "80px SpottedFever", "#00AAAA");
	              _this2.Title.x = 100;
	              _this2.Title.y = 200;
	              _this2.Title.textBaseline = "alphabetic";
	              _this2.stage.addChild(_this2.Title);
	              _this2.Instructions = new createjs.Text("Eat smaller dots to grow but don't get eaten!", "20px Roboto", "#00AAAA");
	              ...
	              _this2.Controls = new createjs.Text("Use WASD to move", "20px Roboto", "#00AAAA");
	              _this2.Controls.x = 100;
	              _this2.Controls.y = 280;
	              _this2.Controls.textBaseline = "alphabetic";
	              _this2.stage.addChild(_this2.Controls);
	              _this2.Confirm = new createjs.Text("Choose Your Difficulty!", "20px Roboto", "#00AAAA");
	              ...
	              _this2.EasyText = new createjs.Text("Easy", "20px Roboto", "white");
	              ...
	              _this2.MediumText = new createjs.Text("Med.", "20px Roboto", "white");
	              ...
	              _this2.HardText = new createjs.Text("Hard", "20px Roboto", "white");
	              ...
	              _this2.BlasterOptionText = new createjs.Text("Bonus Challenge?", "20px Roboto", "white");
