	        ...
	        switch (_this2.gameStatus) {
	          case "StartScreen":
	            if (!_this2.startScreenShowing) {
	              ...
	              _this2.Title = new createjs.Text("Dotty Dots", "80px SpottedFever", "#8292CE");
	              _this2.Title.x = 100;
	              _this2.Title.y = 200;
	              _this2.Title.textBaseline = "alphabetic";
	              _this2.stage.addChild(_this2.Title);
	              _this2.Instructions = new createjs.Text("Eat smaller dots to grow but don't get eaten!", "20px Roboto", "#8292CE");
	              ...
	              _this2.Controls = new createjs.Text("Use WASD to move", "20px Roboto", "#8292CE");
	              _this2.Controls.x = 100;
	              _this2.Controls.y = 280;
	              _this2.Controls.textBaseline = "alphabetic";
	              _this2.stage.addChild(_this2.Controls);
	              _this2.Confirm = new createjs.Text("Choose Your Difficulty!", "20px Roboto", "#8292CE");
	              ...
	              _this2.Easy.graphics.beginFill("#A5200B").drawRect(0, 0, 75, 50);
	              _this2.Easy.x = 100;
	              _this2.Easy.y = 350;
	              _this2.stage.addChild(_this2.Easy);
	              _this2.EasyText = new createjs.Text("Easy", "20px Roboto", "#FF7F6B");
	              ...
	              _this2.Medium.graphics.beginFill("#A5200B").drawRect(0, 0, 75, 50);
	              _this2.Medium.x = 200;
	              _this2.Medium.y = 350;
	              _this2.stage.addChild(_this2.Medium);
	              _this2.MediumText = new createjs.Text("Med.", "20px Roboto", "#FF7F6B");
	              ...
	              _this2.Hard.graphics.beginFill("#A5200B").drawRect(0, 0, 75, 50);
	              _this2.Hard.x = 300;
	              _this2.Hard.y = 350;
	              _this2.stage.addChild(_this2.Hard);
	              _this2.HardText = new createjs.Text("Hard", "20px Roboto", "#FF7F6B");
	              ...
	              _this2.BlasterOption.graphics.beginFill("#A5200B").drawRect(0, 0, 175, 50);
	              _this2.BlasterOption.x = 400;
	              _this2.BlasterOption.y = 350;
	              _this2.stage.addChild(_this2.BlasterOption);
	              _this2.BlasterOptionText = new createjs.Text("Extra Hard", "20px Roboto", "#FF7F6B");
	              ...
	              var highlight = function highlight(event) {
	                var a = createjs.Tween.get(event.target).to({ scaleY: 1.1 }, 100);
	              };
	
	              var unhighlight = function unhighlight(event) {
	                var b = createjs.Tween.get(event.target).to({ scaleY: 1 }, 100);
	              };
	
	              _this2.Easy.addEventListener("mouseover", highlight);
	              _this2.Easy.addEventListener("mouseout", unhighlight);
	              _this2.Medium.addEventListener("mouseover", highlight);
	              _this2.Medium.addEventListener("mouseout", unhighlight);
	              _this2.Hard.addEventListener("mouseover", highlight);
	              _this2.Hard.addEventListener("mouseout", unhighlight);
	              _this2.BlasterOption.addEventListener("mouseover", highlight);
	              _this2.BlasterOption.addEventListener("mouseout", unhighlight);
	          ...
	          case "Lost":
	            ...
	            if (!_this2.endScreenShowing) {
	              _this2.Title = new createjs.Text("You Lost!", "50px Arial", "#8292CE");
	              _this2.Title.x = 100;
	              _this2.Title.y = 200;
	              _this2.Title.textBaseline = "alphabetic";
	              _this2.subTitle = new createjs.Text("Press Space to Try Again!", "20px Arial", "#8292CE");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NpcDots = function (_MovingObjects) {
	  ...
	  function NpcDots(stage, game, options) {
	    ...
	    _this.scaredColor = [216, 230, 66];
	    _this.normalColor = [149, 162, 10];
	    _this.angryColor = [165, 32, 11];
	    _this.currentColor = [149, 162, 10];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovingObjects = function (_createjs$Shape) {
	  ...
	  function MovingObjects(stage, game, options) {
	    ...
	    var randomPos = Utils.initialSetupRandomPos(window.innerWidth, window.innerHeight);
	    _this.x = randomPos[0];
	    _this.y = randomPos[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserDot = function (_MovingObjects) {
	  ...
	  function UserDot(stage, game, options) {
	    ...
	    _this.y = 250;
	    _this.vel = [0, 0];
	    _this.graphics._fill.style = "rgb(130, 146, 206)";
	    _this.color = "rgb(130, 146, 206)";
	    _this.beepPos = [0, 0];
	    _this.realPosX = stage.canvas.width / 2;
	    _this.realPosY = stage.canvas.height / 2;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bullets = function (_MovingObjects) {
	  ...
	  function Bullets(stage, game, options) {
	    ...
	    _this.graphics._fill.style = "rgb(255,255,255)";
	    _this.color = "rgb(255,255,255)";
	    _this.timeCount = 0;
	    return _this;
	  }
